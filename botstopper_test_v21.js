...
//}
function getAllProps$1(obj, props = []) {
    if (Object.getPrototypeOf(obj) == null) {
        return props;
    }
    var props_ = Object.getOwnPropertyNames(obj);
    return getAllProps$1(Object.getPrototypeOf(obj), props.concat(props_));
    //if (props_.length > 0) {
    //    return getAllProps(Object.getPrototypeOf(obj), props.concat(props_));
    //}
    //else {
...
function getDocumentProperties() {
    ...
    return getAllProps$1(window.document);
}
...
function getNavigatorProps() {
    //return Object.getOwnPropertyNames(navigator) //window.navigator
    return getAllProps(navigator);
}
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (components !== undefined) {
                ...
                const data_visitor = {
                    ...
                    DocumentProperties: json_documentprops.value.toString().slice(0, 32767),
