    ...
    upload(websiteid, backend_url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (components !== undefined) {
                ...
                console.log(json_browsersideipapi.value['asn'].slice(0, 511));
                const data_visitor = {
                    id: 0,
                    ...
                    IPAPIisBogon: json_browsersideipapi.value['is_bogon'].slice(0, 7),
                    IPAPIisDatacenter: json_browsersideipapi.value['is_datacenter'].slice(0, 7),
                    IPAPIisTor: json_browsersideipapi.value['is_tor'].slice(0, 7),
                    IPAPIisProxy: json_browsersideipapi.value['is_proxy'].slice(0, 7),
                    IPAPIisVPN: json_browsersideipapi.value['is_vpn'].slice(0, 7),
                    IPAPIisAbuser: json_browsersideipapi.value['is_abuser'].slice(0, 7),
                    IPAPICompany: json_browsersideipapi.value['company'].slice(0, 255),
                    IPAPIAsn: json_browsersideipapi.value['asn'].slice(0, 511),
                    IPAPILocation: json_browsersideipapi.value['location'].slice(0, 511),
